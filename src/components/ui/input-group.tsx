  ...
  return (
    <div
      ...
      className={cn(
        ...
        "has-[[data-slot][aria-invalid=true]]:border-destructive has-[[data-slot][aria-invalid=true]]:ring-2 has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[[data-slot][aria-invalid=true]]:ring-offset-2 has-[[data-slot][aria-invalid=true]]:ring-offset-background dark:has-[[data-slot][aria-invalid=true]]:ring-destructive/40",
