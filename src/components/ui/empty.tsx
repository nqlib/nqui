...
function EmptyDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <div
      ...
      className={cn(
        "text-xs text-muted-foreground [&>a:hover]:text-primary [&>a]:underline [&>a]:underline-offset-4",
        className
      )}
      {...props}
    />
...
function EmptyContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "gap-2 text-xs flex w-full max-w-sm min-w-0 flex-col items-center text-balance",
        className
      )}
      {...props}
    />
