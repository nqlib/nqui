  ...
  return (
    <MenubarPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive not-data-[variant=destructive]:focus:**:text-accent-foreground min-h-7 gap-2 px-2 py-1 text-xs data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg:not([class*='size-'])]:size-3.5 group/menubar-item relative flex cursor-default select-none data-[disabled]:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    />
...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      className={cn(
        floatingListItemInteractive,
        "focus:**:text-accent-foreground min-h-7 gap-2 py-1.5 pr-2 pl-8 text-xs data-disabled:opacity-50 relative flex cursor-default select-none data-disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
...
function MenubarRadioItem({
  ...
  return (
    <MenubarPrimitive.RadioItem
      ...
      className={cn(
        floatingListItemInteractive,
        "focus:**:text-accent-foreground min-h-7 gap-2 py-1.5 pr-2 pl-8 text-xs data-disabled:opacity-50 [&_svg:not([class*='size-'])]:size-3.5 relative flex cursor-default select-none data-disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
...
function MenubarSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <IconChevronRight strokeWidth={2} className="ml-auto size-4" />
    </MenubarPrimitive.SubTrigger>
  )
}
